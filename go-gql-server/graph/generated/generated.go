...
func (ec *executionContext) field_Mutation_createBlog_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewBlog2githubᚗcomᚋparikshitgᚋflutter_graphqlᚋgoᚑgqlᚑserverᚋgraphᚋmodelᚐNewBlog(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_blogs(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Blog)
	fc.Result = res
	return ec.marshalNBlog2ᚕᚖgithubᚗcomᚋparikshitgᚋflutter_graphqlᚋgoᚑgqlᚑserverᚋgraphᚋmodelᚐBlogᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNBlog2githubᚗcomᚋparikshitgᚋflutter_graphqlᚋgoᚑgqlᚑserverᚋgraphᚋmodelᚐBlog(ctx context.Context, sel ast.SelectionSet, v model.Blog) graphql.Marshaler {
	return ec._Blog(ctx, sel, &v)
}

func (ec *executionContext) marshalNBlog2ᚕᚖgithubᚗcomᚋparikshitgᚋflutter_graphqlᚋgoᚑgqlᚑserverᚋgraphᚋmodelᚐBlogᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Blog) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNBlog2ᚖgithubᚗcomᚋparikshitgᚋflutter_graphqlᚋgoᚑgqlᚑserverᚋgraphᚋmodelᚐBlog(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNBlog2ᚖgithubᚗcomᚋparikshitgᚋflutter_graphqlᚋgoᚑgqlᚑserverᚋgraphᚋmodelᚐBlog(ctx context.Context, sel ast.SelectionSet, v *model.Blog) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) unmarshalNNewBlog2githubᚗcomᚋparikshitgᚋflutter_graphqlᚋgoᚑgqlᚑserverᚋgraphᚋmodelᚐNewBlog(ctx context.Context, v interface{}) (model.NewBlog, error) {
